...
const About = () => {
  ...
  return (
    <div
      id="about"
      className="bg-black-2 flex min-h-[50vh] w-full flex-col gap-20"
    >
      <div className="bg-black-2 flex min-h-[50vh] w-full flex-col px-40 py-20">
        ...
        <div className="mt-15 flex w-full justify-between">
          <div>
            ...
            <button
              className="text-black-2 mt-20 rounded-3xl bg-green-500 px-5 py-1 text-lg font-bold duration-300 hover:bg-blue-500 hover:text-white"
      ...
      <div className="flex-col px-40 py-20">
        <div className="mt-15 flex w-full justify-between">
          ...
          <div className="w-[70%] px-10 text-2xl text-white">
            <div>
              <h1 className="-mt-10 pb-5 text-4xl text-green-500">
